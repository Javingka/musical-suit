package cc.tallerdinamo.musicalsuit.drummachine;
...
public class PAppletInicialDrumMach extends PApplet  implements PdListenerCallBack,MTListenerCallBack {
	...
	int numEntrada;
	boolean somIn;
	String nameActualSom;
	
//Codigo Bluetooth 
	private static final String DEVICE_ADDRESS =  "20:13:11:12:05:77";	
...
// Criamos uma clase especialmente para botar ali todo o codigo de libPD.
	...
	public void draw() {
		...
		if (somIn) {
			...
			PdBase.sendBang(nameActualSom);
			somIn = false;
		}
	}
	
/* METODOS PROPRIOS DE UM ACTIVITY, ligados direitamente ao ciclo de v//Codigo Bluetooth 
	private static final String DEVICE_ADDRESS =  "00:14:03:11:35:83";	
	private ArduinoReceiver arduinoReceiver = new ArduinoReceiver();ida	
...
//					mValueTV.setText(data);
					try {
						...
						String nameSound = "Sound"+sensorReading;
						nameActualSom = nameSound;
						somIn = true;
