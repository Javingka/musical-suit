...
import cc.tallerdinamo.musicalsuit.R;
...
public class MainActivity extends Activity {
	private static final String TAG = "MusicalSuit_02";
	...
	//Inicializamos o objeto botāo linkando ele com o botāo desenhado no res/layout/activity_main.xml
		Button DrumMach = (Button)this.findViewById(R.id.b1_drum);
		Button BodySeq = (Button)this.findViewById(R.id.b2_sequ);
	//implementamos o Listener para dar as instruçōes quando o botāo for pressionado.
		DrumMach.setOnClickListener(mGlobal_OnClickListener);
		BodySeq.setOnClickListener(mGlobal_OnClickListener);
 ...
 */
	final OnClickListener mGlobal_OnClickListener = new OnClickListener() {
        public void onClick(final View v) {
            switch(v.getId()) {
                case R.id.b2_sequ:
                	Log.i(TAG, "Botāo BodySeq clicado"); //funçāo que imprime na consola                	
 ...
 * 2. o pacote exato onde tiver a clase PAppletInicial */
					intent.setClassName("cc.tallerdinamo.musicalsuit", 
									    "cc.tallerdinamo.musicalsuit.bodysequencer.PAppletInicialBodySeq" );
 ...
 * http://developer.android.com/training/basics/firstapp/starting-activity.html  */
                ...
                break;
                case R.id.b1_drum:
                	Log.i(TAG, "Botāo DrumMach clicado"); 
                	Intent intent_b = new Intent();
                	intent_b.setClassName("cc.tallerdinamo.musicalsuit", 
						    "cc.tallerdinamo.musicalsuit.drummachine.PAppletInicialDrumMach" );
                	float valorX_b = 3.14f;
                	String stringX_b = "qualquer string";
                	intent_b.putExtra("Um float", valorX_b );
                	intent_b.putExtra("Um String",stringX_b);
